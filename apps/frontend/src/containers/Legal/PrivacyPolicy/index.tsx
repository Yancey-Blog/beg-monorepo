  ...
  <>
    ...
    <Article>
      ...
      <Menu>
        ...
        <li>
          <a href="#Owner_and_Data_Controller">IX. Owner and Data Controller</a>
        </li>
      </Menu>
      <Anchor id="Types_of_Data_collected" />
      ...
      <Anchor id="Mode_and_place_of_processing_the_Data" />
      ...
      <Anchor id="The_purposes_of_processing" />
      ...
      <p>
        ...
        Registration and authentication and Interaction with external social
      ...
      <Anchor id="Detailed_information_on_the_processing_of_Personal_Data" />
      ...
      <Anchor id="Additional_information_about_Data_collection_and_processing" />
      <h2>VI. Additional information about Data collection and processing</h2>
      <h3>Legal action</h3>
      <p>
      ...
      <p>
        The interaction and information obtained through this Application are
        always subject to the User’s privacy settings for each social network.
      </p>
      <p>
      ...
      <p>
        ...
        GitHub Inc. and is connected to the GitHub network.
      </p>
      <p>
      ...
      <p>
        ...
        Google Inc. and is connected to the Google network.
      </p>
      <p>
        Personal Data collected: various types of Data as specified in the
        privacy policy of the service.
      ...
      <Anchor id="Definitions_and_legal_references" />
